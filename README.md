...
1. **Add your NVIDIA NIM API Key:** Go to [NVIDIA API Settings](https://build.nvidia.com/settings/api-keys), generate a key, and add it to Hermes (`Settings → Models/Providers → NVIDIA`).
